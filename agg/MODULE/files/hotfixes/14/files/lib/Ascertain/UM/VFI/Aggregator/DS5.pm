package Ascertain::UM::VFI::Aggregator::DS5;
...
sub _aggregate
{
  ...
  #--- EVERYTHING ABOVE IS REQUIRED
	...
	# ---- TIMESLOT
	#2010-12-17 11:53:46
	my $startDate = (defined $d->{DateForStartOfChargeString}) ? $d->{DateForStartOfChargeString} : "";
	my $startTime = (defined $d->{TimeForStartOfChargeString}) ? $d->{TimeForStartOfChargeString} : "";
	...
	my $duration = hex((defined $d->{ChargeableDurationString}) ? $d->{ChargeableDurationString} : 0);
