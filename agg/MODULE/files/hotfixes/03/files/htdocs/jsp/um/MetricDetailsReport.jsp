    ...
    <html:form action="/um/metricDetailsReportProcess">
        <table width="100%" border="0">
			...
			<tr>
             ...
             <tr>
                <td class="filter_label" nowrap="nowrap">
                    Exclude Regenerated Metrics
                </td>
                <td width="1">&nbsp;</td>
                <td class="filter_value" nowrap="nowrap">
                <%
                  String exDuplicates;
                  exDuplicates = request.getParameter("excludeDuplicates");
                  if (exDuplicates == null || "false".equals(exDuplicates))
                  {
                %>
                  <input type="radio" name="excludeDuplicates" value="true"/>
                        Yes
                  &nbsp;&nbsp;
                  <input type="radio" name="excludeDuplicates" value="false" checked="true"/>
                        No
                <%
                  }
                  else
                  {
                %>
                  <input type="radio" name="excludeDuplicates" value="true" checked="true"/>
                        Yes
                    &nbsp;&nbsp;
                  <input type="radio" name="excludeDuplicates" value="false"/>
                        No
                <%
                  }
                %>
