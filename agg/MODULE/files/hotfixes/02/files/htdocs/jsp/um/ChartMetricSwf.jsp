...
<html:form action="/um/chartMetricSwfProcess.do?id=${param.id}&clickStreamId=${requestScope.clickStreamId}" >
	...
	<asc:block>
		...
		<script type='text/javascript'>
		    ...
		    // <![CDATA[
		        ...
		        so.addVariable('data_file', escape('/servlet/ChartMetricSwfDataServlet?clickStreamId=${requestScope.clickStreamId}'));
