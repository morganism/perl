create materialized view MV_F_FILE_RECENT_SHORT2
...
create bitmap index MV_F_FILE_RECENT_short2_03_IDX on MV_F_FILE_RECENT_short2(SOURCE_TYPE);
create bitmap index MV_F_FILE_RECENT_short2_04_IDX on MV_F_FILE_RECENT_short2(EDR_DIRECTION);
create bitmap index MV_F_FILE_RECENT_short2_05_IDX on MV_F_FILE_RECENT_short2(MEASURE_TYPE);
create  index MV_F_FILE_RECENT_short2_06_IDX on MV_F_FILE_RECENT_SHORT2(PERIOD_YEAR);
create  index MV_F_FILE_RECENT_short2_07_IDX on MV_F_FILE_RECENT_SHORT2(PERIOD_QUARTER);
create  index MV_F_FILE_RECENT_short2_08_IDX on MV_F_FILE_RECENT_SHORT2(PERIOD_MONTH);

analyze table MV_F_FILE_RECENT_short2
 estimate statistics
 for table
 for all indexes
