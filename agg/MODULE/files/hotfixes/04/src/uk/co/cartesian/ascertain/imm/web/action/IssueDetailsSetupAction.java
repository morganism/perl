    ...
    throws Exception
    {
    	...
    	if("true".equals(request.getParameter("new_issue")))
    	{
            ...
            try 
            {
                ...
                if (checkLimitHit(issueTypeVersion.getIssueTypeVersionId()))
                {
                    forward = "limit";
                ...
                connection = IssueDetailsTransactionManager.getInstance().getTransaction(request.getSession(), transactionId);
