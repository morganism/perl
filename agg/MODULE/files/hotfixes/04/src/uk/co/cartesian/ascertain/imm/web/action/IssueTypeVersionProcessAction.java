...
extends DispatchAction 
{
    ...
    throws Exception
    {
        ...
        result.setPath(actionForward.getPath() + "&filter_3130=" + issueTypeVersion.getIssueTypeId() + "&sqlParameters{ISSUE_TYPE_ID," + issueTypeVersion.getIssueTypeId() + "}");
        result.setRedirect(true);
        
        Map<String, String> parameters = AscertainSessionUser.getParameters(request);
        parameters.put("ISSUE_TYPE_ID", issueTypeVersion.getIssueTypeId().toString());
    ...
    throws Exception
    {
		...
		try 
		{
			...
			IssueTypeVersionDAO.update(issueTypeVersion, asu.getAscertainUser().getAlias());

			result.setPath(actionFroward.getPath() + "&filter_3130=" + issueTypeVersion.getIssueTypeId() + "&sqlParameters{ISSUE_TYPE_ID," + issueTypeVersion.getIssueTypeId() + "}");
			result.setRedirect(true);
