...
extends Action
{
    ...
    throws Exception
    {
        ...
        List<AttributeFilterConfRef> attributeFilterConfRefList = AttributeFilterConfRefDAO.readAllForImId(id, asu.getParameters(), isGroupPowerUser);
        ...
        List<AttributeColumnConfRef> attributeColumnConfRefList = AttributeColumnConfRefDAO.readAllForImId(Integer.valueOf(imForm.getClassId()), isGroupPowerUser);
