  ...
  begin
    ...
    if new_data then
      ...
      forall i in the_d_period_list.first .. the_d_period_list.last
        delete from f_mrec f
         where f.f_mrec_id in (
               select fmr.f_mrec_id
               from f_mrec fmr,
                    mrec mr
               where fmr.d_period_id = the_d_period_list(i)
               and mr.mrec_definition_id = the_mrec_ref.mrec_definition_id
               and fmr.d_mrec_line_id = the_mrec_ref.mrec_rec.d_mrec_line_id
         );
