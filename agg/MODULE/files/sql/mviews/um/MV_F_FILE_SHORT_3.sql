create materialized view MV_F_FILE_SHORT3
...
create bitmap index MV_F_FILE_short3_04_IDX on MV_F_FILE_short3(EDR_DIRECTION);
create index MV_F_FILE_short3_06_IDX on MV_F_FILE_SHORT3(PERIOD_YEAR);
create index MV_F_FILE_short3_07_IDX on MV_F_FILE_SHORT3(PERIOD_QUARTER);
create index MV_F_FILE_short3_08_IDX on MV_F_FILE_SHORT3(PERIOD_MONTH);

analyze table MV_F_FILE_short3
 estimate statistics
 for table
 for all indexes
