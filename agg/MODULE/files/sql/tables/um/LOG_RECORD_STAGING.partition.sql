...
PARTITION BY LIST (JOB_ID)
    ( PARTITION LOG_RECORD_STAGING_P00000000 VALUES (0)
...
create bitmap index LOG_RECORD_STAGING_04_IDX on LOG_RECORD_STAGING (IS_RELOAD)
  LOCAL
  tablespace UM_DWH_USG_IDX
  pctfree 10
  nologging;

create bitmap index LOG_RECORD_STAGING_05_IDX on LOG_RECORD_STAGING (IS_DELTA)
  LOCAL
  tablespace UM_DWH_USG_IDX
  pctfree 10
  nologging;
