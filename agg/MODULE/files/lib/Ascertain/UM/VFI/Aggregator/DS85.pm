package Ascertain::UM::VFI::Aggregator::DS85;
...
sub _aggregate
{
  ...
  #--- EVERYTHING ABOVE IS REQUIRED
	...
	my $ST_DATA_WAP_OUTBOUND_ROAMERS_STRIP = FALSE;
	...
	if ($edrFilename =~ /\.strip/) 
	{
		...
		{
			$ST_DATA_WAP_OUTBOUND_ROAMERS_STRIP = TRUE; push @serviceTypes, "ST_DATA_WAP_OUTBOUND_ROAMERS_STRIP";
		}
	}
	else
	{
