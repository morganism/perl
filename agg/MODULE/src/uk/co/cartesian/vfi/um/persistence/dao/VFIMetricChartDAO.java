 ...
 *
 */
public class VFIMetricChartDAO
{
    private static final long serialVersionUID = 1L;

    private static Logger logger = LogInitialiser.getLogger(VFIMetricChartDAO.class.getName());
    ...
    throws IOException
    {
        ...
        try
        {
            ...
            {
                logger.debug("VFIMetricChartDAO.getMetricData(): Retrieving metric data points using sql - " + sql);
            }
            ...
            logger.debug("VFIMetricChartDAO.getMetricData(): sql=" + sql);
